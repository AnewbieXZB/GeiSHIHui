...
public class MainGoodsListServlet {

    private String urlStr = Net.MAIN_GOODS_LIST;
    /**
     * 查询货物列表
     */
    public String getJson(int numerical, String tag, String order) {
    ...
    //        url = new URL("http://api.dataoke.com/index.php?r=goodsLink/android");
            ...
            String content = "numerical=" + URLEncoder.encode(String.valueOf(numerical), "UTF-8") + "&appkey=" + URLEncoder.encode("aqj63vrqo2", "UTF-8")
                    +"&tag=" + URLEncoder.encode(tag, "UTF-8")
                    +"&order=" + URLEncoder.encode(order, "UTF-8");
//            String content = "numerical=" + URLEncoder.encode(String.valueOf(numerical), "UTF-8");
            pw.print(content);
            pw.flush();
            pw.close();
