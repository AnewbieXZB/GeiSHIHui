...
public class CategoryGoodsListServlet {

    private String urlStr = Net.CATEGORY_LIST;
    /**
     * 查询货物列表
     */
    public String getJson(String value,int numerical) {
    ...
    //        url = new URL("http://api.dataoke.com/index.php?r=goodsLink/android");
            ...
            String content = "cation=" + URLEncoder.encode(value, "UTF-8")
