...
public class GoodsDetailsServlet {

    private String urlStr = Net.GOODS_DETAILS;
    /**
     * 查询货物列表
     */
    public String getJson(int id,String ification) {
    ...
    //        url = new URL("http://api.dataoke.com/index.php?r=goodsLink/android");
            ...
            String content = "id=" + URLEncoder.encode(String.valueOf(id), "UTF-8")
                    + "&ification=" + URLEncoder.encode(ification, "UTF-8");
