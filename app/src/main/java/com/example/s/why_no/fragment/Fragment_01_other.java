...
public class Fragment_01_other extends Fragment {

    private String category = "other";//其他
...
//        sf_frgament_category = (SwipeRefreshLayout) mView.findViewById(R.id.sf_frgament_category);
    }
}
