...
public class SaveAddressServlet {

    private String urlStr = Net.SAVE_ADDRESS;
    /**
     * 查询货物列表
     */
    public String getJson(String phone,String name,String tel,String region,String address) {
