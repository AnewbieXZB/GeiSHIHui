...
public class ToIntegralExchangeServlet {

    private String urlStr = Net.ACTION_INTEGRAL_EXCHANGE;
    /**
     * 查询货物列表
     */
    public String getJson(String phone,int integral
       , String shopname,String name ,String tel ,String region
       , String address,int integralid ,String img ) {
    ...
    //        url = new URL("http://api.dataoke.com/index.php?r=goodsLink/android");
            ...
            String content = "phone=" + URLEncoder.encode(phone, "UTF-8")
                    + "&integral=" + URLEncoder.encode(String.valueOf(integral), "UTF-8")
                    ...
                    + "&integralid=" + URLEncoder.encode(String.valueOf(integralid), "UTF-8")
