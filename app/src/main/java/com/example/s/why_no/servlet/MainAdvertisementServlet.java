...
public class MainAdvertisementServlet {

    private String urlStr = Net.MAIN_ADVERTISEMENT;
    /**
     * 查询货物列表
     */
...
////            String content = "type=" + URLEncoder.encode("android_quan", "UTF-8") + "&appkey=" + URLEncoder.encode("aqj63vrqo2", "UTF-8")
////                    +"&v=" + URLEncoder.encode(String.valueOf(2), "UTF-8")
////                    +"&page=" + URLEncoder.encode(String.valueOf(page), "UTF-8");
//            String content = "get=" + URLEncoder.encode("lws", "UTF-8");
//            pw.print(content);
//            pw.flush();
//            pw.close();
