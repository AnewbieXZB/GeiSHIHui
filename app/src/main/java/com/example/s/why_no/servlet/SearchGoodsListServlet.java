...
public class SearchGoodsListServlet {

    private String urlStr = Net.SEARCH_KEY_WORD;
    /**
     * 查询货物列表
     */
    public String getJson(String uname , int numerical,String tag,String order) {
    ...
    //        url = new URL("http://api.dataoke.com/index.php?r=goodsLink/android");
            ...
            String content = "uname=" + URLEncoder.encode(uname, "UTF-8")
                    +"&numerical=" + URLEncoder.encode(String.valueOf(numerical), "UTF-8")
